...
|----|----|
| prep_data.qmd | Prepares the dam dataframe from the Connectivity repository for the Multi-Criteria Decision Model by merging additional data and one-hot encoding categorical variables. |
...
| sensitivity_testing | Sensitivity analyses examining how dam scores vary across different weight configurations. |
...
This model accepts any appropriately structured dataframe. For this project, the input data was prepared in the companion `connectivity` and `fatal-flaw` repository using the following datasets:
